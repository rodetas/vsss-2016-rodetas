...
CONFIGURE_CAMERA () {
	...
	uvcdynctrl -d ${CAMERA} -v -s 'Brightness' 110
	uvcdynctrl -d ${CAMERA} -v -s 'Contrast' 170
	uvcdynctrl -d ${CAMERA} -v -s 'Saturation' 220
	...
	uvcdynctrl -d ${CAMERA} -v -s 'Exposure (Absolute)' 5
