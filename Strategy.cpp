...
Point Strategy::applyPotencialField(Point target, Object toRepulsion, Object toDestination){
...
bool Strategy::isBoard(Object object){
 ...
 */
void Strategy::updateCalculus(Object robot, Point destination){
...
void Strategy::setObjects(vector<Object> o){
	this->objects = o;
}
